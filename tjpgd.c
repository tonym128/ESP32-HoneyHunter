...
#ifdef TJPG_USE_PROGMEM

// ESP8266 comparison
// PROGMEM tables with TJPG_USE_PROGMEM defined and JD_TBLCLIP 1
// 380992
// 31308
// 220 ms
// without PROGMEM saturation table (JD_TBLCLIP 0)
// 380096
// 31308
// 190 ms

// RAM tables with TJPG_USE_PROGMEM not defined and JD_TBLCLIP 1
// 380768
// 32524
// 172 ms
// without RAM saturation table (JD_TBLCLIP 0)
// 379952
// 31500
// 180 ms
...
/ *** Modified for Atmel AVR microcontrollers ***
/----------------------------------------------------------------------------*/
...
#define ZIG(n)  pgm_read_byte(&Zig[n])
...
#define IPSF(n) pgm_read_word(&Ipsf[n])
...
#define BYTECLIP(v) pgm_read_byte(&Clip8[(uint16_t)(v) & 0x3FF])
...
{
  if (val < 0) val = 0;
  else if (val > 255) val = 255; // Bodmer add else to speed up clipping
...
#else // Now copy with no PROGMEM enforced...
